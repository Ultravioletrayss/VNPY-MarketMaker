...
class CancelAdvancedOrder(CtaTemplate):
    ...
    def on_tick(self, tick: TickData) -> None:
        ...
        for vt_orderid in vt_orderids:
            ...
            quote_info["valid_depth"] = self.valid_depth  # 当时行情有效深度
            quote_info["quote_levels"] = self.quote_levels  # 策略计划报价深度
            quote_info["pricing_depth"] = self.pricing_depth  # 定价使用深度
            quote_info["fair_price"] = self.fair_price  # 当时基准价
